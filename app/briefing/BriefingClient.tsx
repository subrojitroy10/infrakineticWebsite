...
const briefingFaqItems = [
  ...
  },
  {
    ...
    answer:
      'Sixty minutes. It covers the shared-database architecture, governance and security model, lifecycle spine and signal framework, and calibrated ML intelligence, with time left for your specific questions.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'The Infrakinetic team reaches out within 24 hours to schedule the session at a time that works for you and your team.',
  },
]
    ...
    <>
                ...
                <div className="mt-10 space-y-4">
                  ...
                  <div className="mt-8 rounded-2xl border border-gold-300/30 bg-gold-300/[0.04] p-6">
                    ...
                    <p className="text-sm text-white/60">
                      You&apos;ll speak with a platform engineer, not an SDR.
                      Come with questions.
                    </p>
                  </div>
                </div>
                    ...
                    {submitted ? (
                      ...
                      >
                        ...
                        <p className="mt-2 max-w-xs text-sm text-white/55">
                          The Infrakinetic team will reach out within 24 hours
                          to schedule the platform briefing.
                        </p>
                        <button
                      ...
                      >
                        ...
                        {error ? (
                          ...
                          <p className="text-center text-xs text-white/30">
                            Briefing requests are reviewed by the Infrakinetic
                            team.
                          </p>
                        )}
                      </motion.form>
      ...
      >
        ...
        <p className="mt-6 max-w-2xl text-sm text-white/65">
          In 60 minutes, we walk through how Infrakinetic&apos;s 17 engines, 5
          always-included platform capabilities, and 8-layer security
          architecture map onto your specific commercial, workforce, and finance
          workflows.
        </p>
      </Section>
