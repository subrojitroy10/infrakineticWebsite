...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Bring existing CRM, HRIS, ERP, finance, database, or file-based legacy data into Infrakinetic through governed staging, dependency-aware execution, reconciliation, and explicit verification.',
