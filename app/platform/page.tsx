...
const architecturePillars = [
  ...
  },
  {
    ...
    desc: 'Isolation is enforced at the database layer, not application code. A missed filter returns zero rows, not another tenant\'s data. Cross-tenant ML pooling is structurally impossible. DPDP 2023 compliant by design.',
    color: 'violet',
  },
]
