      ...
      <div className="container-page relative">
                ...
                {submitted ? (
                  ...
                  >
                    ...
                    <p className="mt-2 max-w-xs text-sm text-white/55">
                      The Infrakinetic team will reach out to schedule the
                      platform briefing.
                    </p>
                    <button
        ...
        <Reveal variant="up" delay={0.3} className="mt-20">
          <div className="mx-auto max-w-3xl">
            <h3 className="heading-serif text-center text-2xl md:text-3xl">
              ...
              {faqs.map((faq, i) => (
                <Reveal key={faq.q} variant="up" delay={i * 0.05}>
                  <details
                    ...
                    className="group rounded-xl border border-white/10 bg-white/[0.02] p-5 transition-colors hover:border-gold-400/20"
                  >
                    <summary
                      itemProp="name"
