    ...
    <section className="relative overflow-hidden">
      ...
      <Section id="enterprise" eyebrow={enterprise.eyebrow} title={enterprise.title}>
          ...
          {enterprise.cards.map((c, i) => {
            ...
            return (
              <Reveal key={c.title} variant="up" delay={i * 0.08}>
                <ParallaxCard
                  depth={15 + i * 2}
                  className="group relative h-full overflow-hidden rounded-lg border border-white/10 bg-white/[0.02] p-8 transition-all hover:border-gold-400/30"
                >
        ...
        <Reveal variant="fade" className="mt-20">
          ...
          <div className="mt-8 divide-y divide-white/[0.06] rounded-lg border border-white/10 bg-white/[0.02]">
