...
/**
 * A realistic Noviq app window rendered in HTML/CSS with 3D perspective.
 * This is what makes the page read as a *product* — visitors see the actual
...
const deals = [
  { name: 'Meridian Systems', stage: 'Proposal', stageColor: 'bg-sky-400/15 text-sky-300', value: '$86,000', owner: 'AR' },
  { name: 'Northwind Retail', stage: 'Negotiation', stageColor: 'bg-amber-400/15 text-amber-300', value: '$124,500', owner: 'PK' },
  { name: 'Cobalt Health', stage: 'Won', stageColor: 'bg-teal-400/15 text-teal-300', value: '$58,200', owner: 'SM' },
]
...
function AreaChart() {
  return (
    <svg viewBox="0 0 320 90" className="h-full w-full" preserveAspectRatio="none" aria-hidden>
      ...
      <circle cx="288" cy="16" r="3.5" fill="#050912" stroke="#2dd4bf" strokeWidth="2" />
    </svg>
  )
}
...
export default function DashboardMock() {
  return (
    <div className="relative [perspective:1600px]">
      ...
      <div className="absolute -inset-8 rounded-[2rem] bg-teal-500/10 blur-3xl" aria-hidden />
      ...
      >
        ...
        <div className="overflow-hidden rounded-xl border border-white/10 bg-ink-800/90 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.7)] backdrop-blur-xl">
          ...
          <div className="flex items-center gap-3 border-b border-white/[0.06] bg-white/[0.02] px-4 py-2.5">
            ...
            <div className="mx-auto flex items-center gap-2 rounded-md bg-white/[0.04] px-3 py-1 text-[10px] text-white/40">
              ...
              app.noviq.io/dashboard
            </div>
            <div className="flex items-center gap-3 text-white/30">
              <Search size={13} />
              <Bell size={13} />
              <span className="grid h-5 w-5 place-items-center rounded-full bg-gradient-to-br from-teal-400 to-cyan-400 text-[9px] font-bold text-ink-900">
                Z
              </span>
            </div>
          </div>
          ...
          <div className="flex">
            ...
            <div className="hidden w-40 shrink-0 border-r border-white/[0.06] p-3 sm:block">
              <div className="mb-4 flex items-center gap-2 px-2">
                <span className="grid h-6 w-6 place-items-center rounded-lg bg-gradient-to-br from-teal-400 to-cyan-400 text-[11px] font-bold text-ink-900">
                  N
                </span>
                <span className="text-xs font-semibold text-white">Noviq</span>
              </div>
            ...
            <div className="min-w-0 flex-1 p-4">
              ...
              <div className="mb-3.5 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="rounded-md bg-teal-400/90 px-2 py-1 text-[10px] font-semibold text-ink-900">
                    + New
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2">
                {kpis.map((k) => (
                  <div key={k.label} className="rounded-lg border border-white/[0.06] bg-white/[0.02] p-2.5">
                    ...
                    <p className="mt-0.5 flex items-center gap-1 text-[9px] font-medium text-teal-300">
                      <TrendingUp size={9} />
                      {k.delta}
                    </p>
                  </div>
                ...
                <div className="mb-2 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3 text-[9px] text-white/35">
                    <span className="flex items-center gap-1">
                      <span className="h-1.5 w-1.5 rounded-full bg-teal-400" /> Actual
                    </span>
                    <span className="flex items-center gap-1">
        ...
        >
          <div className="flex items-center gap-2.5 rounded-xl border border-white/10 bg-ink-800/95 px-3.5 py-2.5 shadow-[0_20px_40px_-12px_rgba(0,0,0,0.6)] backdrop-blur">
            <span className="grid h-7 w-7 place-items-center rounded-full bg-teal-400/15 text-teal-300">
              <Check size={13} />
            </span>
            <div>
              <p className="text-[11px] font-semibold text-white">Payroll completed</p>
              <p className="text-[9px] text-white/40">62 employees · 2 min ago</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-2.5 rounded-xl border border-white/10 bg-ink-800/95 px-3.5 py-2.5 shadow-[0_20px_40px_-12px_rgba(0,0,0,0.6)] backdrop-blur">
            <span className="grid h-7 w-7 place-items-center rounded-full bg-cyan-400/15 text-cyan-300">
              <Target size={13} />
            </span>
            <div>
              <p className="text-[11px] font-semibold text-white">New lead assigned</p>
              <p className="text-[9px] text-white/40">Meridian Systems → Ananya</p>
            </div>
          </div>
        </motion.div>
      </motion.div>
