...
import { Check, Sliders, Wallet, Briefcase, FileText, Bell, Key, Database, Building, ArrowRight, ChevronRight } from '../ui/Icons'
      ...
      <div className="mt-14 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <Reveal variant="right" delay={0.1}>
          ...
          >
            ...
            {/* Platform infrastructure callout */}
