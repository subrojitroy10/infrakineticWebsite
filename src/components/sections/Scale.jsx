      ...
      <div className="mt-14 space-y-3">
        {scaleLayers.map((layer, i) => (
          <Reveal key={layer.n} variant="left" delay={i * 0.08}>
            <div className="group relative flex flex-col gap-3 overflow-hidden rounded-2xl border border-white/10 bg-white/[0.02] p-6 transition-all hover:border-teal-400/30 hover:bg-white/[0.04] sm:flex-row sm:items-center sm:gap-8 md:p-8">
              ...
              <div
                ...
                style={{ width: `${25 + i * 22}%` }}
              />
              <span className="relative font-serif text-5xl font-light text-teal-400/80 md:text-6xl">
                {layer.n}
              </span>
