/**
 * FilterChipRow — Pill row with optional status dot + count
 * Replaces plain buttons in PortfolioRadar and other screens
 */
          ...
          <button
            ...
            className={`flex items-center gap-1.5 rounded-full px-3 py-1.5 text-sm font-medium transition-all ${
              variant === 'status' && dotColor
                ...
                : isActive
                ? 'bg-gold-300/20 text-gold-300 border-gold-300/30'
