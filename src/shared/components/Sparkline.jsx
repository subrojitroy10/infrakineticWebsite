/**
 * Sparkline — Inline SVG trend, ~64×20, colour-coded by direction
 * No chart library
 */

// Callers pass brand-token shorthand (e.g. "gold-300"); SVG stroke/fill need
// real color values, not Tailwind class fragments — resolve here.
const TOKEN_COLORS = {
  'gold-300': '#E6D3A3',
  'gold-400': '#D4B88C',
  'gold-500': '#9A8F6A',
